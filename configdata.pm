...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "gcc",
  CFLAGS => [ "-march=armv6k -mtune=mpcore -mfloat-abi=hard -mtp=soft -O2 -mword-relocations -ffunction-sections -fdata-sections", "-O3", "-Wall", "-g", "-O2", "-ftls-model=local-exec", "-march=armv6k", "-mtune=mpcore", "-mfloat-abi=hard", "-mtp=soft" ],
  CPPDEFINES => [ "__3DS__", "NO_SYS_UN_H", "NO_SYSLOG", "DSO_DL=0", "SO_NONE=1" ],
  CPPFLAGS => [ "-D_3DS -I/opt/devkitpro/portlibs/3ds/include -I/opt/devkitpro/libctru/include" ],
  CPPINCLUDES => [ "/opt/devkitpro/devkitARM/arm-none-eabi/include", "/opt/devkitpro/libctru/include" ],
  CROSS_COMPILE => "arm-none-eabi-",
  CXX => "g++",
  CXXFLAGS => [ "-march=armv6k -mtune=mpcore -mfloat-abi=hard -mtp=soft -O2 -mword-relocations -ffunction-sections -fdata-sections", "-O3", "-Wall", "-g", "-O2", "-ftls-model=local-exec", "-march=armv6k", "-mtune=mpcore", "-mfloat-abi=hard", "-mtp=soft" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "-L/opt/devkitpro/portlibs/3ds/lib -L/opt/devkitpro/libctru/lib" ],
  LDLIBS => [  ],
  PERL => "/usr/bin/perl",
  ...
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_APPS", "OPENSSL_NO_ASAN", "OPENSSL_NO_ASM", "OPENSSL_NO_ASYNC", "OPENSSL_NO_CAPIENG", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_DGRAM", "OPENSSL_NO_DTLS", "OPENSSL_NO_DTLS1", "OPENSSL_NO_DTLS1_2", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_ENGINE", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_MSAN", "OPENSSL_NO_SCTP", "OPENSSL_NO_SOCK", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_STDIO", "OPENSSL_NO_TESTS", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UI_CONSOLE", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_DYNAMIC_ENGINE", "OPENSSL_NO_AFALGENG" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [  ],
  openssldir => "/opt/devkitpro/portlibs/3ds",
  options => "--prefix=/opt/devkitpro/portlibs/3ds --openssldir=/opt/devkitpro/portlibs/3ds enable-ssl-trace -D__3DS__ -DNO_SYS_UN_H -DNO_SYSLOG -DDSO_DL=0 -DSO_NONE=1 -O3 -Wall -g -O2 -ftls-model=local-exec -I/opt/devkitpro/devkitARM/arm-none-eabi/include -I/opt/devkitpro/libctru/include -march=armv6k -mtune=mpcore -mfloat-abi=hard -mtp=soft no-afalgeng no-apps no-asan no-asm no-async no-buildtest-c++ no-capieng no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dgram no-dtls no-dtls1 no-dtls1_2 no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-engine no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-sock no-ssl3 no-ssl3-method no-stdio no-tests no-threads no-ubsan no-ui-console no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.26.1",
  perlargv => [ "linux-armv4", "--prefix=/opt/devkitpro/portlibs/3ds", "--openssldir=/opt/devkitpro/portlibs/3ds", "no-shared", "no-dso", "no-engine", "no-asm", "no-stdio", "no-tests", "no-ui", "no-threads", "no-async", "no-sock", "enable-ssl-trace", "-D__3DS__", "-DNO_SYS_UN_H", "-DNO_SYSLOG", "-DDSO_DL=0", "-DSO_NONE=1", "-O3", "-Wall", "-g", "-O2", "-ftls-model=local-exec", "-I/opt/devkitpro/devkitARM/arm-none-eabi/include", "-I/opt/devkitpro/libctru/include", "-march=armv6k", "-mtune=mpcore", "-mfloat-abi=hard", "-mtp=soft" ],
  perlenv => {
      "AR" => "arm-none-eabi-gcc-ar",
      "BUILDFILE" => undef,
      "CC" => undef,
